	...
	
	{
		
		{
			data = 
			{
				...
				timelineIndex = 1,
				timerOffset = -10,
				uuid = "839e7e80-b2fb-b773-a720-3686ed65792a",
				version = 2,
			},
			inheritedIndex = 2,
		},
		
		{
			data = 
			{
				...
				timerOffset = -4,
				timerStartOffset = -2,
				uuid = "1048a2db-8b9d-8e20-8e41-7399ec544c51",
				version = 2,
			},
			inheritedIndex = 3,
		},
		
		{
			data = 
			{
				...
				timerOffset = -4,
				timerStartOffset = -4,
				uuid = "d0de7962-ae3e-6c41-86ce-2f841afdfeaa",
				version = 2,
			},
			inheritedIndex = 4,
		},
		...
		
		{
			data = 
			{
				...
				timelineIndex = 1,
				timerOffset = -6,
				uuid = "7365622f-3bdb-de64-9203-f56ac4ea15b6",
				version = 2,
			},
		},
		
		{
			data = 
			{
				...
				timelineIndex = 1,
				timerOffset = -5,
				uuid = "d3fbfb8d-1730-b764-b9b0-905ae9b9d639",
				version = 2,
			},
		},
		
		{
			data = 
			{
				...
				timelineIndex = 1,
				timerOffset = -7,
				uuid = "f03ec447-107e-de2f-b8a4-ff6eafdf0f2f",
				version = 2,
			},
		},
		
		{
			data = 
			{
				...
				timelineIndex = 1,
				timerOffset = 7,
				uuid = "fcabebab-baca-4a68-8751-b61505629017",
				version = 2,
			},
		},
	}, 
	...
	[8] = 
	{
		
		{
			data = 
			{
				...
				uuid = "c6c40dc7-d34e-9148-80b1-b4ade0f8ea33",
				version = 2,
			},
			inheritedIndex = 1,
		},
	...
	[18] = 
	{
		
		{
			data = 
			{
				...
				timelineIndex = 18,
				timerStartOffset = -2.5,
				uuid = "2ceb98db-417e-7385-a3a3-30666aab409c",
				version = 2,
			},
			inheritedIndex = 1,
		},
	...
	[27] = 
	{
					...
					
					{
						data = 
						{
							...
							conditions = 
							{
								...
								{
									"c8024d81-fa4a-7af3-af5f-04ddf5ebcb83",
									true,
								},
							},
				...
				conditions = 
				{
					...
					
					{
						data = 
						{
							...
							uuid = "c8024d81-fa4a-7af3-af5f-04ddf5ebcb83",
							version = 3,
						},
					},
				},
		...
		
		{
			data = 
			{
					...
					
					{
						data = 
						{
							...
							conditions = 
							{
								...
								{
									"a0c66996-a45f-6fd9-8e4b-898589d1cdfd",
									true,
								},
							},
							gVar = "ACR_RikuPLD3_Tankbar_Guardian",
				...
				conditions = 
				{
					
					{
						data = 
						{
							...
							conditionLua = "local me = Player\nif not me then return false end\n\nlocal list = EntityList(\"contentid=14369\") or {}\nfor _, e in pairs(list) do\n    if e and e.id ~= 0 and e.targetid == me.id then\n        return true\n    end\nend\n\nreturn false\n",
							name = "DeepBlue targeting self",
							uuid = "a0c66996-a45f-6fd9-8e4b-898589d1cdfd",
							version = 3,
						},
					},
				},
				...
				timerOffset = -8,
				timerStartOffset = -8,
				uuid = "1f12e627-f09a-d5da-8178-e70f05c51b46",
				version = 2,
			},
			inheritedIndex = 2,
		},
		
		{
			data = 
			{
					...
					
					{
						data = 
						{
							...
							conditions = 
							{
								...
								{
									"14742a8b-7ea7-46c2-90c1-4b36fa0ded70",
									true,
								},
							},
							endIfUsed = true,
				...
				conditions = 
				{
					...
					
					{
						data = 
						{
							...
							conditionLua = "local me = Player\nif not me then return false end\n\nlocal list = EntityList(\"contentid=14369\") or {}\nfor _, e in pairs(list) do\n    if e and e.id ~= 0 and e.targetid == me.id then\n        return true\n    end\nend\n\nreturn false\n",
							name = "DeepBlue targeting self",
							uuid = "14742a8b-7ea7-46c2-90c1-4b36fa0ded70",
							version = 3,
						},
					},
				},
				...
				timerOffset = -4,
				timerStartOffset = -2,
				uuid = "70df021c-7d7c-484b-8951-c0d1da25911b",
				version = 2,
			},
			inheritedIndex = 3,
		},
		
		{
			data = 
			{
					...
					
					{
						data = 
						{
							...
							conditions = 
							{
								...
								{
									"f0d79a8c-2579-6745-80c5-279996794163",
									true,
								},
							},
							gVar = "ACR_RikuPLD3_Tankbar_Bulwark",
				...
				conditions = 
				{
					
					{
						data = 
						{
							...
							conditionLua = "local me = Player\nif not me then return false end\n\nlocal list = EntityList(\"contentid=14369\") or {}\nfor _, e in pairs(list) do\n    if e and e.id ~= 0 and e.targetid == me.id then\n        return true\n    end\nend\n\nreturn false\n",
							name = "DeepBlue targeting self",
							uuid = "f0d79a8c-2579-6745-80c5-279996794163",
							version = 3,
						},
					},
				},
				...
				timerOffset = -4,
				timerStartOffset = -6,
				uuid = "adc0e030-4e01-26f6-a124-27a51aaccef0",
				version = 2,
			},
			inheritedIndex = 4,
		},
		...
		
		{
			data = 
			{
					...
					
					{
						data = 
						{
							...
							conditions = 
							{
								...
								{
									"8c384194-a79b-3c49-8e99-cd939739f981",
									true,
								},
							},
				...
				conditions = 
				{
					
					{
						data = 
						{
							...
							conditionLua = "local me = Player\nif not me then return false end\n\nlocal list = EntityList(\"contentid=14369\") or {}\nfor _, e in pairs(list) do\n    if e and e.id ~= 0 and e.targetid == me.id then\n        return true\n    end\nend\n\nreturn false\n",
							name = "DeepBlue targeting self",
							uuid = "8c384194-a79b-3c49-8e99-cd939739f981",
							version = 3,
						},
					},
				},
				...
				timerOffset = -3,
				timerStartOffset = -1,
				uuid = "3a067ed9-8fee-ff56-b155-4871522afc39",
				version = 2,
			},
		},
	},
	[28] = 
	{
		...
		
		{
			data = 
			{
				...
				timerOffset = 1,
				timerStartOffset = -1,
				uuid = "7a9dd1c2-8563-7aad-84c9-bec3f7e04567",
				version = 2,
			},
		},
		
		{
			data = 
			{
				...
				timerOffset = -3,
				timerStartOffset = -1,
				uuid = "24df6d34-d2c1-5677-8a54-0c620f2b7952",
				version = 2,
			},
		},
	},
	...
	[43] = 
	{
		
		{
			data = 
			{
				...
				timerEndOffset = 35,
				timerStartOffset = -15,
				uuid = "3ff6c2d3-08aa-cda3-bc16-3b6b13f57c64",
				version = 2,
			},
			inheritedIndex = 1,
		},
		
		{
			data = 
			{
				...
				timerEndOffset = 35,
				timerStartOffset = -15,
				uuid = "8013239f-25e8-3cb8-bfbc-3aecd49969a0",
				version = 2,
			},
			inheritedIndex = 2,
		},
	...
	[45] = 
	{
		
		{
			data = 
			{
				...
				timerOffset = -3,
				timerStartOffset = -3,
				uuid = "8a4a337f-979f-72fe-8932-ed497542557d",
				version = 2,
			},
		},
		
		{
			data = 
			{
				...
				timerOffset = -5,
				timerStartOffset = -5,
				uuid = "2f6e7a19-7f7e-455e-bc9f-8371d65419fe",
				version = 2,
			},
		},
	},
	[48] = 
	{
		
		{
			data = 
			{
				...
				timerOffset = -3,
				timerStartOffset = -3,
				uuid = "f1fe4cb7-d8d9-88a3-8914-65bcd087633c",
				version = 2,
			},
		},
		
		{
			data = 
			{
				...
				timerOffset = -5,
				timerStartOffset = -5,
				uuid = "39a6e81b-b3b5-64b2-bd05-00a50a991975",
				version = 2,
			},
		},
	},
	[51] = 
	{
		
		{
			data = 
			{
				...
				timerOffset = -3,
				timerStartOffset = -3,
				uuid = "818ab845-f14e-fe26-99c7-257d913630c8",
				version = 2,
			},
		},
		
		{
			data = 
			{
				...
				timerOffset = -5,
				timerStartOffset = -5,
				uuid = "6c5c73e4-e572-939b-813f-b0f1d0e9c7a1",
				version = 2,
			},
		},
	},
	[54] = 
	{
		
		{
			data = 
			{
				...
				timerOffset = -3,
				timerStartOffset = -3,
				uuid = "08d7036c-ce55-d776-8f99-e92a9406264d",
				version = 2,
			},
		},
		
		{
			data = 
			{
				...
				timerOffset = -5,
				timerStartOffset = -5,
				uuid = "25ef546a-e604-5e5a-bf3b-c2b6aaaab2af",
				version = 2,
			},
		},
	},
	...
	[56] = 
	{
		...
		
		{
			data = 
			{
				...
				timelineIndex = 56,
				timerStartOffset = -2.5,
				uuid = "9e0025c2-afd6-8d8f-87c2-da5835106bc3",
				version = 2,
			},
			inheritedIndex = 3,
		},
	...
	[63] = 
	{
		
		{
			data = 
			{
				...
				timerOffset = -8,
				timerStartOffset = -8,
				uuid = "3b8f9aa1-0270-931c-a6b0-50a1580bb85e",
				version = 2,
			},
			inheritedIndex = 2,
		},
		
		{
			data = 
			{
				...
				timerOffset = -4,
				timerStartOffset = -2,
				uuid = "1e911729-e318-1807-b5e9-a015a9366f62",
				version = 2,
			},
			inheritedIndex = 3,
		},
	...
	[85] = 
	{
		...
		
		{
			data = 
			{
				...
				timerOffset = 1,
				timerStartOffset = -1,
				uuid = "e166bfd6-76e5-6cfc-819d-515d93455d28",
				version = 2,
			},
		},
		
		{
			data = 
			{
				...
				timerOffset = -3,
				timerStartOffset = -1,
				uuid = "11a04055-0147-31f6-bbee-99201d930172",
				version = 2,
			},
		},
	},
	...
	[111] = 
	{
		
		{
			data = 
			{
				...
				timelineIndex = 111,
				timerStartOffset = -2.5,
				uuid = "103f9306-99a3-daf3-9232-03b1700ea6bc",
				version = 2,
			},
			inheritedIndex = 1,
		},
	...
	[117] = 
	{
		
		{
			data = 
			{
				...
				timelineIndex = 117,
				timerStartOffset = -2.5,
				uuid = "2e37619c-1599-49be-9af9-50383cdc264f",
				version = 2,
			},
			inheritedIndex = 1,
		},
	...
	[155] = 
	{
		
		{
			data = 
			{
				...
				timelineIndex = 155,
				timerOffset = -10,
				uuid = "f81c8e91-f6e7-6cb5-b492-eda5a632a1b1",
				version = 2,
			},
			inheritedIndex = 2,
		},
		
		{
			data = 
			{
				...
				timerOffset = -4,
				timerStartOffset = -2,
				uuid = "8e3012d2-33a5-88a0-8987-ec77ea742c82",
				version = 2,
			},
			inheritedIndex = 3,
		},
		
		{
			data = 
			{
				...
				timerOffset = -4,
				timerStartOffset = -6,
				uuid = "58009bab-e166-8e0e-8d0b-fef31d5c0641",
				version = 2,
			},
			inheritedIndex = 4,
		},
		...
		
		{
			data = 
			{
				...
				timerOffset = 1,
				timerStartOffset = -1,
				uuid = "b9d73a29-c9c3-3bf6-8b3c-3a4a8f6ba463",
				version = 2,
			},
		},
		
		{
			data = 
			{
				...
				timerOffset = -3,
				timerStartOffset = -1,
				uuid = "832b6b6e-cf71-8723-95fa-33d4ef216a2a",
				version = 2,
			},
		},
	},
